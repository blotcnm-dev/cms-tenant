    ...
    <main>
        <div id="wrap" class="white">
            ...
            <div class="page_title">
                ...
                <h2 class="title">배너 상세</h2>
            </div>
            <!-- 페이지 타이틀 E -->

            <!-- 컨텐츠 S -->
            <div class="container">
                <form id="mainForm" action="{{ route('banner.update', $banner_content->promotions_id) }}" method="POST" enctype="multipart/form-data" class="max_width">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="promotions_type" value="banner">
                    <input type="hidden" name="device" value="A">
                    <input type="hidden" name="is_view" value="{{$banner_content->is_view}}">
                    <input type="hidden" name="is_state" value="{{$banner_content->is_state}}">
                    <input type="hidden" name="position" value="{{$banner_content->position}}">
                    <div class="input_box gray_box">
                        <div class="input_item">
                            <label class="input_title" for="banner_title">제목</label>
                            <div class="inner_box">
                                <input type="text" class="common_input" id="banner_title" placeholder="제목을 입력하세요" name="title" value="{{ $banner_content->title }}">
                            </div>
                        ...
                        <div class="input_item">
                            ...
                            <div class="inner_box">
                                <div class="uploadFile_box">
                                    <input type="file" id="banner_img" name="banner_img" accept="image/jpeg, image/png, image/gif" value="{{ $banner_content->pc_img }}">
                                    <div class="type_txt">
                                    ...
                                    <div class="type_img">
                                        <div class="img_box" id="file_box" style="display: {{ ($banner_content->pc_img)  ? 'block' : 'none' }}">
                                            <img src="{{ ($banner_content->pc_img)  ? $banner_content->pc_img : '' }}" alt="" id="preViewImg">
                        ...
                        <div class="input_item url">
                            ...
                            <div class="inner_box flex">
                                <input type="text" class="common_input" id="banner_url" name="path" value="{{ $banner_content->path }}">
                                <label class="chk_input">
                                    <input type="checkbox" name="target" value="_blank" {{ ($banner_content->target)  ? 'checked' : '' }}>
                                    <span>새 창에서 열기</span>
                                </label>
                            </div>
                        </div>
                        <div class="input_item">
                            ...
                            <div class="inner_box">
                                <div class="textarea_count">
                                    <textarea class="common_textarea" id="banner_text" name="info" placeholder="내용을 입력해주세요">{{ $banner_content->info }}</textarea>
                        ...
                        <div class="input_item half w_4">
                            ...
                            <div class="inner_box">
                                <div class="custom_select_1 js_custom_select">
                                    <input type="text" id="id_is_view" class="common_input select_value" name="is_view_txt" placeholder="선택" data-value="{{ $banner_content->is_view }}" value="{{ $banner_content->is_view_txt }}" readonly>
                                    <ul role="list">
                        ...
                        <div class="input_item half date w_6">
                            ...
                            <div class="inner_box">
                                <div class="calendar_input">
                                    <input type="date" class="common_input check_is_date" name="sdate" value="{{ $banner_content->sdate }}">
                                </div>
                                <span>~</span>
                                <div class="calendar_input">
                                    <input type="date" class="common_input check_is_date" name="edate" value="{{ $banner_content->edate }}">
                                </div>
                            </div>
                        </div>
                        <div class="input_item half input_gap w_4">
                            <label class="input_title">노출 여부</label>
                            <div class="inner_box">
                                <div class="custom_select_1 js_custom_select">
                                    <input type="text" class="common_input select_value" name="is_state_txt" placeholder="선택" data-value="{{ $banner_content->is_state }}" value="{{ $banner_content->is_state_txt }}" readonly>
                                    <ul role="list">
                        ...
                        <div class="input_item half w_6">
                            ...
                            <div class="inner_box">
                                <div class="custom_select_1 js_custom_select">
                                    <input type="text" class="common_input select_value" name="position_txt" placeholder="선택" data-value="{{ $banner_content->position }}" value="{{ $banner_content->position_txt }}" readonly>
                                    <ul role="list">
                        ...
                        <div class="input_item half input_gap">
                            ...
                            <div class="inner_box flex gap_input">
                                <label class="radio_input">
                                    <input type="radio" id="today_1" name="is_today" value="Y" {{ ($banner_content->is_today == 'Y')  ? 'checked' : '' }}>
                                    <span>사용</span>
                                </label>
                                <label class="radio_input">
                                    <input type="radio" id="today_2" name="is_today"  value="N" {{ ($banner_content->is_today == 'N')  ? 'checked' : '' }}>
                                    <span>사용안함</span>
                                </label>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('mainForm').addEventListener('submit', function(e) {
                ...
                const url = '{{ route('banner.update', $banner_content->promotions_id) }}';
