...
@section('required-page-title', '게시판 등록')
...
@section('required-page-main-content')
    <main>
        <div id="wrap" class="white">
            ...
            <!-- 컨텐츠 S -->
            <div class="container">
                <form id="mainForm" action="{{ route('configBoards.store') }}" method="POST" enctype="multipart/form-data" class="max_width">
                    @csrf
                    <input type="hidden" name="board_config_id" id="board_config_id" value="reg">
                    ...
                    <input type="hidden" name="list_view_authority_type" value="">
                    <input type="hidden" name="content_view_authority_type" value="">
                    <input type="hidden" name="content_write_authority_type" value="">
                    <input type="hidden" name="reply_write_authority_type" value="">
                    <input type="hidden" name="gallery_theme" value="">
                    ...
                    <div class="input_box gray_box">
                        <div class="input_item half">
                            ...
                            <div class="inner_box no_wrap">
                                <div class="custom_select_1 js_custom_select">
                                    <input type="text" class="common_input select_value" placeholder="선택" data-value="" name="is_category_tmp" value="" readonly>
                        ...
                        <div class="input_item half">
                            ...
                            <div class="inner_box">
                                <div class="custom_select_1 js_custom_select select_type">
                                    <input type="text" class="common_input select_value" placeholder="선택" data-value="COMMON" value="게시판" name="board_type_tmp" readonly>
                                    <ul role="list">
                        ...
                        <div class="input_item">
                            ...
                            <div class="inner_box">
                                <input type="text" class="common_input" id="board_title" placeholder="제목을 입력하세요" name="board_name" value="{{ old('board_name') }}">
                            </div>
                    ...
                    <div class="input_box gray_box">
                        <div class="input_item half">
                            ...
                            <div class="inner_box">
                                <div class="custom_select_1 js_custom_select">
                                    <input type="text" class="common_input select_value" placeholder="선택" data-value="" name="list_view_authority_type_tmp" value="" readonly>
                                    <ul role="list">
                        ...
                        <div class="input_item half">
                            ...
                            <div class="inner_box">
                                <div class="custom_select_1 js_custom_select">
                                    <input type="text" class="common_input select_value" placeholder="선택" data-value="" name="content_view_authority_type_tmp" value="" readonly>
                                    <ul role="list">
                                        <li role="listitem" data-value="0">전체</li>
                                        @foreach($member_level as $config)
                                            <li role="listitem" data-value="{{ $config->code }}">{{ $config->code_name }}</li>
                        ...
                        <div class="input_item half">
                            ...
                            <div class="inner_box">
                                <div class="custom_select_1 js_custom_select">
                                    <input type="text" class="common_input select_value" placeholder="선택" data-value="" name="content_write_authority_type_tmp" value="" readonly>
                                    <ul role="list">
                                        <li role="listitem" data-value="0">전체</li>
                                        @foreach($member_level as $config)
                                            <li role="listitem" data-value="{{ $config->code }}">{{ $config->code_name }}</li>
                        ...
                        <div class="input_item half">
                            ...
                            <div class="inner_box">
                                <div class="custom_select_1 js_custom_select">
                                    <input type="text" class="common_input select_value" placeholder="선택" data-value="" name="reply_write_authority_type_tmp" value="" readonly>
                                    <ul role="list">
                                        <li role="listitem" data-value="0">전체</li>
                                        @foreach($member_level as $config)
                                            <li role="listitem" data-value="{{ $config->code }}">{{ $config->code_name }}</li>
                    ...
                    <div class="input_box gray_box type_box type_board">
                        <div class="input_box">
                            <div class="input_item half">
                                <label class="input_title">댓글 사용 여부</label>
                                <div class="inner_box flex gap_input">
                                    <label class="radio_input">
                                        <input type="radio" name="is_reply" id="comment_use_y" value="1">
                                        <span>사용</span>
                                    </label>
                                    <label class="radio_input">
                                        <input type="radio" name="is_reply" id="comment_use_n" value="0" checked>
                                        <span>사용안함</span>
                                    </label>
                                </div>
                            </div>
                            <div class="input_item half">
                                ...
                                <div class="inner_box flex gap_input">
                                    <label class="radio_input">
                                        <input type="radio" name="is_reply_like" id="comment_like_y" value="1" disabled>
                                        <span>사용</span>
                                    </label>
                                    <label class="radio_input">
                                        <input type="radio" name="is_reply_like" id="comment_like_n" value="0" disabled checked>
                                        <span>사용안함</span>
                                    </label>
                                </div>
                            </div>
                            <div class="input_item half">
                                ...
                                <div class="inner_box flex gap_input">
                                    <label class="radio_input">
                                        <input type="radio" name="is_reply_photo" id="comment_img_y" value="1" disabled>
                                        <span>사용</span>
                                    </label>
                                    <label class="radio_input">
                                        <input type="radio" name="is_reply_photo" id="comment_img_n" value="0" disabled checked>
                                        <span>사용안함</span>
                                    </label>
                                </div>
                            </div>
                            <div class="input_item half">
                                ...
                                <div class="inner_box flex gap_input">
                                    <label class="radio_input">
                                        <input type="radio" name="is_like" id="board_like_y" value="1">
                                        <span>사용</span>
                                    </label>
                                    <label class="radio_input">
                                        <input type="radio" name="is_like" id="board_like_n" value="0" checked>
                                        <span>사용안함</span>
                                    </label>
                                </div>
                            </div>
                            <div class="input_item half">
                                ...
                                <div class="inner_box flex gap_input">
                                    <label class="radio_input">
                                        <input type="radio" name="is_ban" id="board_forbid_y" value="1">
                                        <span>사용</span>
                                    </label>
                                    <label class="radio_input">
                                        <input type="radio" name="is_ban" id="board_forbid_n" value="0" checked>
                                        <span>사용안함</span>
                                    </label>
                                </div>
                            </div>
                            <div class="input_item half">
                                ...
                                <div class="inner_box flex gap_input">
                                    <label class="radio_input">
                                        <input type="radio" name="is_secret" id="board_secret_y" value="1">
                                        <span>사용</span>
                                    </label>
                                    <label class="radio_input">
                                        <input type="radio" name="is_secret" id="board_secret_n" value="0" checked>
                                        <span>사용안함</span>
                                    </label>
                                </div>
                            </div>
                            <div class="input_item half">
                                ...
                                <div class="inner_box flex gap_input">
                                    <label class="radio_input">
                                        <input type="radio" name="is_topfix" id="board_pin_y" value="1">
                                        <span>사용</span>
                                    </label>
                                    <label class="radio_input">
                                        <input type="radio" name="is_topfix" id="board_pin_n" value="0" checked>
                                        <span>사용안함</span>
                                    </label>
                                </div>
                            </div>
                            <div class="input_item half board">
                                ...
                                <div class="inner_box flex gap_input">
                                    <label class="radio_input">
                                        <input type="radio" name="is_file" id="board_upload_file_y" value="1">
                                        <span>사용</span>
                                    </label>
                                    <label class="radio_input">
                                        <input type="radio" name="is_file" id="board_upload_file_n" value="0" checked>
                                        <span>사용안함</span>
                                    </label>
                                </div>
                            </div>
                            <div class="input_item half board">
                                ...
                                <div class="inner_box">
                                    <input type="tel" class="common_input" name="file_uploadable_count" value="" readonly>
                                </div>
                            </div>
                            <div class="input_item half board">
                                ...
                                <div class="inner_box capacity">
                                    <p>파일당</p>
                                    <input type="tel" class="common_input" name="file_max_size" value="" readonly>
                                    <span>MB 이하</span>
                                </div>
                            </div>
                            <div class="input_item half gallery">
                                ...
                                <div class="inner_box">
                                    <input type="tel" class="common_input" name="gallery_uploadable_count" value="">
                                </div>
                            </div>
                            <div class="input_item half gallery">
                                <label class="input_title file_mb">
                                ...
                                <div class="inner_box capacity">
                                    <p>파일당</p>
                                    <input type="tel" class="common_input" name="gallery_max_size" value="">
                                    <span>MB 이하</span>
                                </div>
                            </div>
                            <div class="input_item half gallery">
                                ...
                                <div class="inner_box">
                                    <div class="custom_select_1 js_custom_select">
                                        <input type="text" class="common_input select_value" placeholder="선택" data-value="" name="gallery_theme_tmp" value="" readonly>
                                        <ul role="list">
                            ...
                            <div class="input_item">
                                ...
                                <div class="inner_box">
                                    <input type="text" class="common_input" name="incoming_mail" value="">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('mainForm').addEventListener('submit', function(e) {
                ...
                const url = '{{ route('configBoards.store') }}';
                ...
                fetch( url , {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            if (data.errors.board_type) {
                                document.getElementById('board_type_error').textContent = data.errors.board_type[0];
                                document.getElementById('board_type_error').style.display = 'block';
                            }
                            // 버튼 다시 활성화
