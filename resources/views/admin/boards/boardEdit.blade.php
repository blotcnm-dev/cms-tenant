...
@section('required-page-title', '게시물 수정')
...
@section('required-page-main-content')
    <main>
        <div id="wrap" class="white">
            ...
            <!-- 컨텐츠 S -->
            <div class="container">
                <form id="mainForm" action="{{ route('boards.board.update', [$board_config->board_id]) }}" method="POST" enctype="multipart/form-data" class="max_width">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="input_box gray_box">
                        ...
                        <div class="input_item">
                            ...
                            <div class="inner_box">
                                <input type="text" class="common_input" id="post_title" placeholder="제목을 입력하세요" name="subject" value="{{ $boards->subject }}">
                            </div>
                                        ...
                                        <div class="type_img">
                                            ...
                                            @foreach($files as $file)
                                                <div class="img_box">
                                                    ...
                                                    <img src="{{$file->path}}" alt="미리보기">
                                                    <button type="button" class="del_btn" aria-label="삭제하기"></button>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                    ...
                    <div class="common_bottom_btn fixed">
                        <a href="{{ route('boards.board.show', [$board_config->board_id,$boards->post_id]) }}" class="border_btn cancel">
                            <span>취소</span>
                        </a>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('mainForm').addEventListener('submit', function(e) {
                ...
                const url = '{{ route('boards.board.update', [$board_config->board_id]) }}';
                ...
                fetch( url , {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            // 성공 시 처리
                            window.location.href = data.redirect || '{{ route('boards.board.show', [$board_config->board_id,$boards->post_id]) }}';
                        } else {
