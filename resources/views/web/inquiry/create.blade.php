...
@section('required-page-title', '1:1 문의 등록')
    ...
    <main>
        <section class="container_edit">
            <div class="container w-820">
                <h2 class="section_title">1:1 문의 등록</h2>
                <form id="mainForm" action="{{ route('front_inquiry.store') }}" method="POST" enctype="multipart/form-data" class="max_width">
                    @csrf
                    ...
                    <div class="board_controller">
                        <a href="{{ route('front_inquiry.index') }}" >목록으로</a>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('mainForm').addEventListener('submit', function(e) {
                ...
                const url = '{{ route('front_inquiry.store') }}';
                ...
                fetch( url , {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            // 성공 시 처리
                            window.location.href = data.redirect || '{{ route('front_inquiry.index') }}';
                        } else {
