    ...
    <main>
        <section class="wrapper_container">
            <div class="container w-560">
                <h2 class="section_title">BLOT : 회원정보수정</h2>
                    ...
                    @if($profileConfig->first()->use == '1')
                        <div class="input_item_container">
                            ...
                            <div class="profile_image_container">
                                <img src="{{ asset($member->profile_image) }}" alt="프로필 사진" onerror="this.onerror=null; this.src='{{ asset('/web/images/members_default.jpg') }}';">

                            </div>
                            <div class="input_button_container profile_button_container">
                                <input type="file" id="user_profile" name="profile_image"  value="{{ $member->profile_image }}">
                                <input type="hidden" id="profile_image_change"  name="profile_image_change" value="0">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById('mainForm').addEventListener('submit', function(e) {
            ...
            const url = '{{ route('front_member.update', $member->member_id ) }}';
            ...
            fetch( url , {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        window.location.href = data.redirect || '{{ route('index') }}';
                    } else {
                        if(data.message){ alert(data.message); }
